    ...
    return (
        <>
            ...
            <div className="hidden lg:flex w-full lg:w-1/2 main-page-image justify-around items-center">
                ...
                <div className="w-full mx-auto px-36 flex-col items-center space-y-6">
                    <h1 className="text-red-500 font-bold text-6xl font-sans">PHONE STORE</h1>
                    <p className="text-black px-24 mt-1">Supply Chain Management</p>
                    <div className="flex justify-center px-28 lg:justify-start mt-6">
                        <Link to="/login" className="hover:bg-indigo-700 hover:text-white hover:-translate-y-1 transition-all duration-500 bg-green-300 text-indigo-800 mt-4 px-4 py-2 rounded-2xl font-bold mb-2">Get Started</Link>
                    </div>
                </div>
            </div>
