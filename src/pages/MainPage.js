            ...
            <section className="bg-white">
                <div className="max-w-screen-xl px-4 py-12 mx-auto space-y-8 overflow-hidden sm:px-6 lg:px-8">
                    <nav className="flex flex-wrap justify-center -mx-5 -my-2">
                        ...
                        <div className="px-5 py-2">
                            <Link to="/About" className=" text-muted text-blue-400 hover:text-orange-500">
                                About
                            </Link>
                        </div>
                        <div className="px-5 py-2">
                            <Link to="/Contact" className=" text-muted text-blue-400 hover:text-orange-500">
                                Contact
                            </Link>
                        </div>
                        <div className="px-5 py-2">
                            <a href="#" className=" text-muted text-blue-400 hover:text-orange-500">
                                Terms
                            </a>
                        </div>
                    </nav>
                    ...
                    <p className="mt-8 text-base leading-6 text-center text-gray-400">
                        © 2023 Hoicko Company, Inc. All rights reserved.
                    </p>
                </div>
            </section>
        </>
