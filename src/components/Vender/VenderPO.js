        ...
        await axios
            .post(
                "http://localhost:3010/vendor_po",
                {
                    ...
                    will_deliver_within: values.will_deliver_within,
                    po_copy: values.po_copy,
                },
                {
                    headers: {
            ...
            <div className="min-w-screen min-h-screen bg-gray-900 flex items-center justify-center px-5 py-5">
                <div className="bg-gray-100 text-gray-500 rounded-3xl shadow-xl w-full overflow-hidden" >
                    <div className="md:flex w-full">
                        ...
                        <div className='py-8 px-8 md:px-10 lg:px-24'>
                            <form className="bg-white rounded-3xl shadow-2xl p-11 ">
                                <h1 className="text-gray-800 text-center font-bold text-2xl mb-1">Vender Purchase Order</h1>
                                ...
                                <div className="text-center">
                                    <Link to="/VenderReqView" className=" text-2xl  text-muted text-blue-400 hover:text-orange-500">
                                        View Requirement
                                    </Link>
                                </div>
